...
class MongoLoader:
    ...
    def get_collection(
        ...
        if collection_name not in collection_names:
            ...
            self.database.create_collection(collection_name, timeseries=timeseries)
    ...
    def load(self, tickers: list[types.Ticker], interval: str) -> bool:
        ...
        logger.info(f"Got collection {collection} for inserting {len(dictionaries)} dictionaries")
